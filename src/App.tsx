...
- 추가규칙: (이 내용과 스타일에 특화된 추가 규칙 1~2개)
...
- **네거티브 조건:** 16컷이 아닌 컷 수, 2열 8행 이외의 그리드 레이아웃, 불균일한 패널 크기, 경계선 없는 레이아웃, 워터마크, 서명, 로고 없음.
...
- **네거티브 조건:** 12컷을 초과하는 컷 수, 2열 6행 이외의 그리드 레이아웃, 불균일한 패널 크기, 경계선 없는 레이아웃, 워터마크, 서명, 로고 없음.
